...
*/
class SolarisPackageFinderTest {
	@ParameterizedTest
	@ValueSource(strings = { "3.5.5", "3.4.0 -> 3.4.5", "3.3.1", "3.2.0 -> 3.2.14", "3.0.0 -> 3.0.15", "2.6.0 -> 2.6.12" })
	public void Solaris(String version) {
		assertThat(withPlatform(CommonOS.Solaris, CommonArchitecture.X86_64), version)
		  .resolvesTo("/sunos5/mongodb-sunos5-x86_64-{}.tgz");
	}
	...
	private static HtmlParserResultTester assertThatTools(Platform platform, String versionList) {
		return HtmlParserResultTester.with(
			new SolarisPackageFinder(Command.MongoDump),
