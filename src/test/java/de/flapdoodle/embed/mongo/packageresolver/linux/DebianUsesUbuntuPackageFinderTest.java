...
class DebianUsesUbuntuPackageFinderTest {
	@ParameterizedTest
	...
	public void ubuntu22x64(String version) {
		...
		assertThat(linuxWith(CommonArchitecture.X86_64, DebianVersion.DEBIAN_13), version)
			.resolvesTo("/linux/mongodb-linux-x86_64-ubuntu2204-{}.tgz");
	}
	...
	private static HtmlParserResultTester assertThat(Platform platform, String versionList) {
		return HtmlParserResultTester.with(
			new DebianUsesUbuntuPackageFinder(new UbuntuPackageFinder(Command.Mongo)),
