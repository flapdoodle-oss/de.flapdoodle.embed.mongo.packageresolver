...
class DebianPackageFinderTest {
	@ParameterizedTest
	@ValueSource(strings = { "8.1.0-rc0", "8.1.0", "8.0.6-rc2", "8.0.0-rc9", "8.0.0-rc7", "8.0.0-rc3", "7.3.3-rc0", "7.3.0 -> 7.3.3", "7.2.0-rc3", "7.0.18-rc0", "7.0.15-rc1", "7.0.8-rc0" })
	...
	@ParameterizedTest
	@ValueSource(strings = { "100.12.0", "100.11.0", "100.10.0", "100.9.2 -> 100.9.5" })
	...
	@ParameterizedTest
	@ValueSource(strings = { "100.12.0", "100.11.0", "100.10.0", "100.9.0 -> 100.9.5", "100.8.0", "100.7.0 -> 100.7.5", "100.6.0 -> 100.6.1", "100.5.3 -> 100.5.4" })
