...
class DebianPackageFinderTest {
	@ParameterizedTest
	@ValueSource(strings = { "7.1.0", "7.0.3-rc1", "7.0.0-rc8", "7.0.0-rc2", "7.0.0-rc10", "7.0.0-rc1", "6.3.1 -> 6.3.2", "6.0.9-rc1", "5.0.20-rc1" })
	...
	@ParameterizedTest
	@ValueSource(strings = { "7.0.0 -> 7.0.2", "6.0.0 -> 6.0.11", "5.0.8 -> 5.0.22" })
	...
	@ParameterizedTest
	@ValueSource(strings = { "100.9.0", "100.8.0", "100.7.0 -> 100.7.5", "100.6.0 -> 100.6.1", "100.5.3 -> 100.5.4" })
	...
	@ParameterizedTest
	@ValueSource(strings = { "7.0.0-rc2", "7.0.0-rc1", "6.3.1 -> 6.3.2", "6.0.9-rc1", "5.0.20-rc1", "4.4.24-rc0" })
	...
	@ParameterizedTest
	@ValueSource(strings = { "6.0.0 -> 6.0.11", "5.0.0 -> 5.0.22", "4.4.0 -> 4.4.25", "4.2.5 -> 4.2.24", "4.2.1 -> 4.2.3" })
	...
	@ParameterizedTest
	@ValueSource(strings = { "5.0.20-rc1", "4.4.24-rc0" })
	...
	@ParameterizedTest
	@ValueSource(strings = { "5.0.0 -> 5.0.22", "4.4.0 -> 4.4.25", "4.2.5 -> 4.2.24", "4.2.0 -> 4.2.3", "4.0.0 -> 4.0.28", "3.6.5 -> 3.6.23" })
