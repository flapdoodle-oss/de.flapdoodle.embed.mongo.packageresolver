...
class RedhatPackageFinderTest {
	@ParameterizedTest
	@ValueSource(strings = { "100.17.0" })
	public void Redhat_10ArmTools(String version) {
		assertThatTools(withPlatform(CommonOS.Linux, CommonArchitecture.ARM_64, RedhatVersion.Redhat_10), version)
			.resolvesTo("/tools/db/mongodb-database-tools-rhel10-aarch64-{}.tgz");
	}

	@ParameterizedTest
	@ValueSource(strings = { "100.17.0" })
	public void Redhat_10Tools(String version) {
		assertThatTools(withPlatform(CommonOS.Linux, CommonArchitecture.X86_64, RedhatVersion.Redhat_10), version)
			.resolvesTo("/tools/db/mongodb-database-tools-rhel10-x86_64-{}.tgz");
	}

	@ParameterizedTest
	@ValueSource(strings = { "8.0.0-rc9", "8.0.0-rc7", "8.0.0-rc3", "7.3.3-rc0", "7.3.0 -> 7.3.3", "7.2.0-rc3", "7.1.0 -> 7.1.1", "7.0.27-rc0", "7.0.21-rc0", "7.0.18-rc0", "7.0.15-rc1", "7.0.8-rc0", "7.0.3-rc1", "7.0.0-rc8", "7.0.0-rc2", "7.0.0-rc10", "6.0.24-rc0", "6.0.21-rc1", "6.0.16-rc0", "6.0.9-rc1" })
	...
	@ParameterizedTest
	@ValueSource(strings = { "7.0.34", "7.0.28 -> 7.0.32", "7.0.14 -> 7.0.26", "7.0.11 -> 7.0.12", "7.0.0 -> 7.0.9", "6.0.7 -> 6.0.28" })
	...
	@ParameterizedTest
	@ValueSource(strings = { "8.2.0-rc0", "8.1.0 -> 8.1.2", "8.0.10-rc0", "8.0.6-rc2" })
	public void Redhat_9Arm_1Dev(String version) {
		assertThat(withPlatform(CommonOS.Linux, CommonArchitecture.ARM_64, RedhatVersion.Redhat_9), version)
			.resolveDevPackageTo("/linux/mongodb-linux-aarch64-rhel93-{}.tgz");
	}
	@ParameterizedTest
	@ValueSource(strings = { "8.3.0 -> 8.3.2", "8.2.9", "8.2.0 -> 8.2.7", "8.0.23", "8.0.3 -> 8.0.21", "8.0.0 -> 8.0.1" })
	...
	@ParameterizedTest
	@ValueSource(strings = { "100.17.0", "100.16.0 -> 100.16.1", "100.15.0", "100.14.0 -> 100.14.1", "100.13.0", "100.12.0 -> 100.12.2", "100.11.0", "100.10.0" })
	...
	@ParameterizedTest
	@ValueSource(strings = { "8.0.0-rc9", "8.0.0-rc7", "8.0.0-rc3", "7.3.3-rc0", "7.3.0 -> 7.3.3", "7.2.0-rc3", "7.1.0 -> 7.1.1", "7.0.27-rc0", "7.0.21-rc0", "7.0.18-rc0", "7.0.15-rc1", "7.0.8-rc0", "7.0.3-rc1", "7.0.0-rc8", "7.0.0-rc2", "7.0.0-rc10", "7.0.0-rc1", "6.3.1 -> 6.3.2", "6.0.24-rc0", "6.0.21-rc1", "6.0.16-rc0", "6.0.9-rc1" })
	...
	@ParameterizedTest
	@ValueSource(strings = { "7.0.34", "7.0.28 -> 7.0.32", "7.0.14 -> 7.0.26", "7.0.11 -> 7.0.12", "7.0.0 -> 7.0.9", "6.0.4 -> 6.0.28" })
	...
	@ParameterizedTest
	@ValueSource(strings = { "7.0.11 -> 7.0.12", "7.0.0 -> 7.0.9", "6.0.0 -> 6.0.16", "5.0.0 -> 5.0.28", "4.4.4 -> 4.4.30" })
	...
	@ParameterizedTest
	// partial
	@ValueSource(strings = { "8.2.0-rc0", "8.1.0 -> 8.1.2", "8.0.10-rc0", "8.0.6-rc2", /*"7.0.27-rc0", "7.0.21-rc0", "7.0.18-rc0", "7.0.15-rc1", "6.0.24-rc0", "6.0.21-rc1"*/ })
	public void Redhat_8Arm_1Dev(String version) {
		assertThat(withPlatform(CommonOS.Linux, CommonArchitecture.ARM_64, RedhatVersion.Redhat_8), version)
			.resolveDevPackageTo("/linux/mongodb-linux-aarch64-rhel8-{}.tgz");
	}
	@ParameterizedTest
	@ValueSource(strings = { "8.3.0 -> 8.3.2", "8.2.9", "8.2.0 -> 8.2.7", "8.0.23", "8.0.3 -> 8.0.21", "8.0.0 -> 8.0.1", "7.0.34", "7.0.28 -> 7.0.32", "7.0.14 -> 7.0.26", "6.0.17 -> 6.0.28", "5.0.29 -> 5.0.33" })
	...
	@ParameterizedTest
	@ValueSource(strings = { "7.0.11 -> 7.0.12", "7.0.0 -> 7.0.9", "6.0.0 -> 6.0.16", "5.0.0 -> 5.0.28", "4.4.0 -> 4.4.30", "4.2.5 -> 4.2.25", "4.2.1 -> 4.2.3", "4.0.14 -> 4.0.28", "3.6.17 -> 3.6.23", "3.4.24" })
	...
	@ParameterizedTest
	@ValueSource(strings = { "7.3.3-rc0", "7.3.0 -> 7.3.3", "7.1.0 -> 7.1.1", "7.0.27-rc0", "7.0.21-rc0", "7.0.18-rc0", "7.0.15-rc1", "7.0.8-rc0", "7.0.3-rc1", "7.0.0-rc8", "7.0.0-rc2", "7.0.0-rc10", "7.0.0-rc1", "6.3.1 -> 6.3.2", "6.0.24-rc0", "6.0.21-rc1", "6.0.16-rc0", "6.0.9-rc1", "5.0.28-rc0", "5.0.20-rc1", "4.4.27-rc0", "4.4.24-rc0" })
	...
	@ParameterizedTest
	@ValueSource(strings = { "7.0.34", "7.0.28 -> 7.0.32", "7.0.14 -> 7.0.26", "7.0.11 -> 7.0.12", "7.0.0 -> 7.0.9", "6.0.0 -> 6.0.28", "5.0.0 -> 5.0.33", "4.4.0 -> 4.4.30", "4.2.5 -> 4.2.25", "4.2.0 -> 4.2.3", "4.0.0 -> 4.0.28", "3.6.0 -> 3.6.23", "3.4.9 -> 3.4.24", "3.4.0 -> 3.4.7", "3.2.0 -> 3.2.22", "3.0.0 -> 3.0.15" })
	...
	@ParameterizedTest
	@ValueSource(strings = { "4.4.0 -> 4.4.30", "4.2.5 -> 4.2.25", "4.2.0 -> 4.2.3", "4.0.0 -> 4.0.28", "3.6.0 -> 3.6.23", "3.4.9 -> 3.4.24", "3.4.0 -> 3.4.7", "3.2.0 -> 3.2.22", "3.0.0 -> 3.0.15" })
