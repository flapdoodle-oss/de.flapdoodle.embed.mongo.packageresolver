...
class RedhatPackageFinderTest {
	...
	@ParameterizedTest
	@ValueSource(strings = { "7.0.28", "7.0.14 -> 7.0.26", "7.0.11 -> 7.0.12", "7.0.0 -> 7.0.9", "6.0.7 -> 6.0.27" })
	...
	@ParameterizedTest
	@ValueSource(strings = { "7.0.28", "7.0.14 -> 7.0.26", "7.0.11 -> 7.0.12", "7.0.0 -> 7.0.9", "6.0.4 -> 6.0.27" })
	...
	@ParameterizedTest
	@ValueSource(strings = { "8.2.0 -> 8.2.3", "8.0.3 -> 8.0.17", "8.0.0 -> 8.0.1", "7.0.28", "7.0.14 -> 7.0.26", "6.0.17 -> 6.0.27", "5.0.29 -> 5.0.32" })
	...
	@ParameterizedTest
	@ValueSource(strings = { "7.0.28", "7.0.14 -> 7.0.26", "7.0.11 -> 7.0.12", "7.0.0 -> 7.0.9", "6.0.0 -> 6.0.27", "5.0.0 -> 5.0.32", "4.4.0 -> 4.4.30", "4.2.5 -> 4.2.25", "4.2.0 -> 4.2.3", "4.0.0 -> 4.0.28", "3.6.0 -> 3.6.23", "3.4.9 -> 3.4.24", "3.4.0 -> 3.4.7", "3.2.0 -> 3.2.22", "3.0.0 -> 3.0.15" })
