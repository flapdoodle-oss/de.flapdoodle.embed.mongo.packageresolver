...
class RedhatPackageFinderTest {
	@ParameterizedTest
	@ValueSource(strings = { "8.0.0-rc9", "8.0.0-rc7", "8.0.0-rc3", "7.3.3-rc0", "7.3.0 -> 7.3.3", "7.2.0-rc3", "7.1.0 -> 7.1.1", "7.0.21-rc0", "7.0.18-rc0", "7.0.15-rc1", "7.0.8-rc0", "7.0.3-rc1", "7.0.0-rc8", "7.0.0-rc2", "7.0.0-rc10", "6.0.24-rc0", "6.0.21-rc1", "6.0.16-rc0", "6.0.9-rc1" })
	...
	@ParameterizedTest
	@ValueSource(strings = { "7.0.14 -> 7.0.22", "7.0.11 -> 7.0.12", "7.0.0 -> 7.0.9", "6.0.7 -> 6.0.25" })
	...
	@ParameterizedTest
	@ValueSource(strings = { "8.0.0-rc9", "8.0.0-rc7", "8.0.0-rc3", "7.3.3-rc0", "7.3.0 -> 7.3.3", "7.2.0-rc3", "7.1.0 -> 7.1.1", "7.0.21-rc0", "7.0.18-rc0", "7.0.15-rc1", "7.0.8-rc0", "7.0.3-rc1", "7.0.0-rc8", "7.0.0-rc2", "7.0.0-rc10", "7.0.0-rc1", "6.3.1 -> 6.3.2", "6.0.24-rc0", "6.0.21-rc1", "6.0.16-rc0", "6.0.9-rc1" })
	...
	@ParameterizedTest
	@ValueSource(strings = { "7.0.14 -> 7.0.22", "7.0.11 -> 7.0.12", "7.0.0 -> 7.0.9", "6.0.4 -> 6.0.25" })
	...
	@ParameterizedTest
	// partial
	@ValueSource(strings = { "8.2.0-rc0", "8.1.0 -> 8.1.2", "8.0.10-rc0", "8.0.6-rc2", /*"7.0.21-rc0", "7.0.18-rc0", "7.0.15-rc1", "6.0.24-rc0", "6.0.21-rc1"*/ })
	public void Redhat_8Arm_1Dev(String version) {
		assertThat(withPlatform(CommonOS.Linux, CommonArchitecture.ARM_64, RedhatVersion.Redhat_8), version)
			.resolveDevPackageTo("/linux/mongodb-linux-aarch64-rhel8-{}.tgz");
	}
	@ParameterizedTest
	@ValueSource(strings = { "8.0.3 -> 8.0.12", "8.0.0 -> 8.0.1", "7.0.14 -> 7.0.22", "6.0.17 -> 6.0.25", "5.0.29 -> 5.0.31" })
	...
	@ParameterizedTest
	@ValueSource(strings = { "7.3.3-rc0", "7.3.0 -> 7.3.3", "7.1.0 -> 7.1.1", "7.0.21-rc0", "7.0.18-rc0", "7.0.15-rc1", "7.0.8-rc0", "7.0.3-rc1", "7.0.0-rc8", "7.0.0-rc2", "7.0.0-rc10", "7.0.0-rc1", "6.3.1 -> 6.3.2", "6.0.24-rc0", "6.0.21-rc1", "6.0.16-rc0", "6.0.9-rc1", "5.0.28-rc0", "5.0.20-rc1", "4.4.27-rc0", "4.4.24-rc0" })
	...
	@ParameterizedTest
	@ValueSource(strings = { "7.0.14 -> 7.0.22", "7.0.11 -> 7.0.12", "7.0.0 -> 7.0.9", "6.0.0 -> 6.0.25", "5.0.0 -> 5.0.31", "4.4.0 -> 4.4.29", "4.2.5 -> 4.2.25", "4.2.0 -> 4.2.3", "4.0.0 -> 4.0.28", "3.6.0 -> 3.6.23", "3.4.9 -> 3.4.24", "3.4.0 -> 3.4.7", "3.2.0 -> 3.2.22", "3.0.0 -> 3.0.15" })
