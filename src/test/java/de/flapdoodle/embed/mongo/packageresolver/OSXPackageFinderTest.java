...
class OSXPackageFinderTest {
	...
	@ParameterizedTest
	@ValueSource(strings = { "8.0.3 -> 8.0.5", "8.0.0 -> 8.0.1", "7.0.14 -> 7.0.17", "7.0.11 -> 7.0.12", "7.0.0 -> 7.0.9", "6.0.0 -> 6.0.21" })
	...
	@ParameterizedTest
	@ValueSource(strings = { "100.11.0", "100.10.0", "100.9.0 -> 100.9.5", "100.8.0", "100.7.1 -> 100.7.5" })
	...
	@ParameterizedTest
	@ValueSource(strings = { "8.0.3 -> 8.0.5", "8.0.0 -> 8.0.1", "7.0.14 -> 7.0.17", "7.0.11 -> 7.0.12", "7.0.0 -> 7.0.9", "6.0.0 -> 6.0.21", "5.0.0 -> 5.0.31", "4.4.0 -> 4.4.29", "4.2.5 -> 4.2.25", "4.2.0 -> 4.2.3" })
