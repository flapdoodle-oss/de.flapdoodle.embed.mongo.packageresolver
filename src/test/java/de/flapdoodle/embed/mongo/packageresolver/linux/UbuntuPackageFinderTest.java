...
class UbuntuPackageFinderTest {
	...
	@ParameterizedTest
	@ValueSource(strings = { "8.0.3 -> 8.0.12", "8.0.0 -> 8.0.1" })
	...
	@ParameterizedTest
	@ValueSource(strings = { "100.12.0 -> 100.12.2", "100.11.0", "100.10.0" })
	...
	@ParameterizedTest
	@ValueSource(strings = { "8.2.0-rc0", "8.1.0 -> 8.1.2", "8.0.10-rc0", "8.0.6-rc2", "8.0.0-rc9", "8.0.0-rc7", "8.0.0-rc3", "7.3.3-rc0", "7.3.0 -> 7.3.3", "7.2.0-rc3", "7.1.0 -> 7.1.1", "7.0.21-rc0", "7.0.18-rc0", "7.0.15-rc1", "7.0.8-rc0", "7.0.3-rc1", "7.0.0-rc8", "7.0.0-rc2", "7.0.0-rc10", "7.0.0-rc1", "6.3.1 -> 6.3.2", "6.0.24-rc0", "6.0.21-rc1", "6.0.16-rc0", "6.0.9-rc1" })
	...
	@ParameterizedTest
	@ValueSource(strings = { "8.0.3 -> 8.0.12", "8.0.0 -> 8.0.1", "7.0.14 -> 7.0.22", "7.0.11 -> 7.0.12", "7.0.0 -> 7.0.9", "6.0.4 -> 6.0.25" })
	...
	@ParameterizedTest
	@ValueSource(strings = { "100.12.0 -> 100.12.2", "100.11.0", "100.10.0", "100.9.0 -> 100.9.5", "100.8.0", "100.7.0 -> 100.7.5", "100.6.0 -> 100.6.1", "100.5.4" })
	...
	@ParameterizedTest
	@ValueSource(strings = { "8.0.3 -> 8.0.12", "8.0.0 -> 8.0.1", "7.0.14 -> 7.0.22", "7.0.11 -> 7.0.12", "7.0.0 -> 7.0.9", "6.0.0 -> 6.0.25", "5.0.0 -> 5.0.31", "4.4.0 -> 4.4.29" })
	...
	@ParameterizedTest
	@ValueSource(strings = { "100.12.0 -> 100.12.2", "100.11.0", "100.10.0", "100.9.0 -> 100.9.5", "100.8.0", "100.7.0 -> 100.7.5", "100.6.0 -> 100.6.1", "100.5.0 -> 100.5.4", "100.4.0 -> 100.4.1", "100.3.0 -> 100.3.1", "100.2.0 -> 100.2.1", "100.1.0 -> 100.1.1" })
	...
	@ParameterizedTest
	@ValueSource(strings = { "6.0.0 -> 6.0.25", "5.0.0 -> 5.0.31", "4.4.0 -> 4.4.29", "4.2.5 -> 4.2.25", "4.2.0 -> 4.2.3" })
	...
	@ParameterizedTest
	@ValueSource(strings = { "100.12.0 -> 100.12.2", "100.11.0", "100.10.0", "100.9.0 -> 100.9.5", "100.8.0", "100.7.0 -> 100.7.5", "100.6.0 -> 100.6.1", "100.5.0 -> 100.5.4", "100.4.0 -> 100.4.1", "100.3.0 -> 100.3.1", "100.2.0 -> 100.2.1", "100.1.0 -> 100.1.1", "100.0.0 -> 100.0.2", "99.0.0" })
	...
	@ParameterizedTest
	@ValueSource(strings = { "6.0.0 -> 6.0.25", "5.0.0 -> 5.0.31", "4.4.0 -> 4.4.29", "4.2.5 -> 4.2.25", "4.2.0 -> 4.2.3", "4.0.1 -> 4.0.28", "3.6.20 -> 3.6.23" })
